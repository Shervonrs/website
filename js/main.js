...
// $(document).ready(function(){
//   var scene =$('.js-parallax-cloudLayer')[0];
//   var parallax = new Parallax(scene, {
//     relativeInput: true
//   })
// })
...
$('<img src="./img/bay.jpg">'), $('<img src="./img/brush.jpg">'), $('<img src="./img/purp.jpg">'), $(window).on("load", function(){
  anime.timeline().add({
    targets: ".loader",
    translateY : [0, "-100%"],
    translateZ: 0,
...
Barba.Dispatcher.on("newPageReady", function(){
  if($("#js-fullpage").length) new Parallax($(".js-parallax-mtn").get(0));
  isSp && $(".page-top").height($(window).height())
}), $(function() {
  fullPage();
  const height= $(window).height();
  $(".js-menuBtn").on("click", function() {
    $(".menuIcon").toggleClass("js-menuOpen"), $(".navigation").toggleClass("js-open"), $(window).scrollTop() > height && $("header").toggleClass("js-color"), $(this).hasClass("js-menuOpen") ? (console.log("curation"), Barba.Pjax.getTransition = function(){
  ...
  open: function() {
    return new Promise(function(resolve){
      anime({
        ...
        easing: "easeInOutCubic",
        complete: function(){
          $(".menuIcon").removeClass("js-menuOpen"), $(".navigation").removeClass("js-open"), $("body, html").scrollTop(0), resolve()
        }
      })
    })
  },
...
PageTransitionUnder = Barba.BaseTransition.extend({
  ...
  close: function(){
    return new Promise(function(resolve){
      const closeAnime = anime.timeline({
        duration: 500,
        easing: "easeInOutCubic",
        autoplay: !1,
        complete: function(){
